...
const STEPS: Step[] = [
  {
    ...
    media: { kind: 'image', src: `${V}/instagram_reel_image.webp` },
  },
  {
    n: '02',
    ...
    media: { kind: 'video', src: `${V}/inspiration_share.webm` },
  },
  {
    n: '03',
    ...
    media: { kind: 'video', src: `${V}/organise_inspiration.webm` },
  },
  {
    n: '04',
    ...
    media: { kind: 'video', src: `${V}/turn_into_trip.webm` },
  },
];
