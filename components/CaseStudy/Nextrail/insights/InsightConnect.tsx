...
const MAP = '/nextrail_casestudy/worldmap.webp';
...
const SHOTS: Shot[] = [
  { src: `${B}/beach.webp`, left: -34, top: -34, h: 50, rot: -5, fy: 7, dur: 6.4, delay: 0.0 }, // top-left
  { src: `${B}/autumn.webp`, left: 66, top: -35, h: 50, rot: 6, fy: 6, dur: 6.1, delay: 0.5 }, // top-right
  { src: `${B}/street.webp`, left: 90, top: 2, h: 50, rot: -5, fy: 8, dur: 7.1, delay: 1.6 }, // right upper
  { src: `${B}/dock.webp`, left: 91, top: 60, h: 62, rot: -4, fy: 9, dur: 8.2, delay: 1.9 }, // right lower
  { src: `${B}/road.webp`, left: 64, top: 88, h: 48, rot: 5, fy: 8, dur: 6.9, delay: 0.8 }, // bottom-right
  { src: `${B}/shore.webp`, left: -32, top: 86, h: 48, rot: 5, fy: 9, dur: 7.4, delay: 0.3 }, // bottom-left
  { src: `${B}/towers.webp`, left: -40, top: 34, h: 52, rot: -3, fy: 7, dur: 6.6, delay: 1.1 }, // left lower
  { src: `${B}/aerial.webp`, left: -38, top: 2, h: 50, rot: 4, fy: 8, dur: 7.7, delay: 2.0 }, // left upper
  { src: `${B}/falls.webp`, left: 34, top: -40, h: 46, rot: 3, fy: 7, dur: 7.5, delay: 1.3 }, // top centre
  { src: `${B}/sunset.webp`, left: 90, top: 32, h: 52, rot: 4, fy: 8, dur: 6.8, delay: 0.6 }, // right mid
  { src: `${B}/travelers.webp`, left: 34, top: 90, h: 46, rot: -4, fy: 6, dur: 5.6, delay: 2.4 }, // bottom centre
  { src: `${B}/lake.webp`, left: -38, top: 66, h: 50, rot: 6, fy: 9, dur: 7.9, delay: 1.5 }, // left lower-2
];
