...
const SHOTS: Shot[] = [
  { src: `${B}/beach.webp`, left: -7, top: -11, h: 88, rot: -4, z: 1, fy: 10, dur: 6.6, delay: 0.0 },
  { src: `${B}/falls.webp`, left: 22, top: -13, h: 92, rot: 3, z: 1, fy: 12, dur: 8.0, delay: 1.5 },
  { src: `${B}/autumn.webp`, left: 50, top: -8, h: 80, rot: -3, z: 1, fy: 9, dur: 6.1, delay: 0.6 },
  { src: `${B}/dock.webp`, left: 80, top: -15, h: 120, rot: -6, z: 2, fy: 13, dur: 8.9, delay: 0.9 },
  { src: `${B}/towers.webp`, left: -6, top: 40, h: 78, rot: 4, z: 3, fy: 11, dur: 7.3, delay: 2.0 },
  { src: `${B}/travelers.webp`, left: 26, top: 46, h: 64, rot: 5, z: 4, fy: 8, dur: 5.4, delay: 1.1 },
  { src: `${B}/road.webp`, left: 52, top: 41, h: 72, rot: -5, z: 3, fy: 14, dur: 7.7, delay: 2.4 },
  { src: `${B}/lake.webp`, left: 71, top: 47, h: 60, rot: 7, z: 4, fy: 10, dur: 6.4, delay: 0.4 },
];
