...
export function DefiningDeck() {
  ...
  const canExpand = useMediaQuery('(min-width: 1024px) and (hover: hover) and (pointer: fine)');
  const showCarousel = !canExpand;
  ...
  return (
    <>
      <DeckStack active={showCarousel} reduced={reduced} />
