...
/* -------------------------------------------------------------------------- */
/*  Inline SVG icon set for the ClearHost case study.                          */
/*                                                                            */
/*  The reference pulls ~40 icons from lucide-react; this portfolio ships no   */
/*  icon library, so the handful the case study actually uses are inlined as   */
/*  plain 24×24 stroke glyphs. Common signature: `size` (px, default 16) plus  */
/*  a `className` passthrough so module CSS can still colour / position them.   */
/* -------------------------------------------------------------------------- */
...
/** Shape of every glyph exported from this file. */
...
export const Play = (p: IconProps) => (
  <Svg {...p} fill="currentColor">
    <path d="M6 3.713a1 1 0 0 1 1.5-.866l13 8.286a1 1 0 0 1 0 1.734l-13 8.286A1 1 0 0 1 6 20.287z" />
  </Svg>
);
...
export const StickyNote = (p: IconProps) => (
  <Svg {...p}>
    <path d="M16 3H5a2 2 0 0 0-2 2v14c0 1.1.9 2 2 2h11l6-6V5a2 2 0 0 0-2-2z" />
