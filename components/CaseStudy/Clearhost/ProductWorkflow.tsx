...
export function ProductWorkflow() {
  ...
  useGSAP(
    () => {
      ...
      mm.add(
        {
          // keep the scroll-driven horizontal pan on essentially every phone
          // (iPhone SE / small Androids included), not just ≥380px
          isWide: '(min-width: 360px)',
          ...
          if (isWide) {
            ...
            container = gsap.to(track.current, {
              ...
              scrollTrigger: {
                ...
                // Positive, not negative: this pin's spacer reserves real scroll
                // height, so on a ScrollTrigger.refresh() it must settle *before*
                // triggers further down the page (the footer's curve reveal)
                // measure their own start/end — otherwise those cache against a
                // too-short document and read as permanently "past end".
                refreshPriority: 1,
                onUpdate: (self) => {
        ...
        <div className={styles.container}>
          <div className={styles.intro}>
            ...
            <h2 className={styles.h2}>
              From what I found <span className={styles.accent}>to what I built.</span>
            </h2>
