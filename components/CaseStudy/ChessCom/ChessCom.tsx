        ...
        >
          {DECISIONS.map((item, i) => (
            ...
            >
              ...
              <img src={`/case-study/move-types/${item.icon}.webp`} alt="" width={24} height={24} />
        ...
        <div className={styles.drPanel}>
          <div key={active} className={styles.drPanelInner}>
            <p className={styles.drKicker}>
              Decision {d.n}
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src={`/case-study/move-types/${d.icon}.webp`} alt="" width={18} height={18} />
        ...
        <div className={styles.tileFrame}>
          <div className={styles.bStack}>
            {BADGES.map((b, i) => (
              ...
              >
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img src={`/case-study/move-types/${b.icon}.webp`} alt="" width={28} height={28} />
                {b.name}
              </span>
            ))}
        ...
        <div className={styles.tileFrame}>
          <div className={styles.bRows}>
            ...
            <div className={`${styles.bRow} ${styles.bRowSolved}`}>
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/case-study/move-types/best.webp" alt="" width={18} height={18} />
